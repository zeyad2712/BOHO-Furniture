...
function CategorisSection() {
    return (
        ...
        <>
            <div id='categories' className='py-8'></div>
            ...
            >
                ...
                <div
                    className="container categories-grid mx-auto"
                    style={{
                        display: 'grid',
                        ...
                        .map((category, idx) => (
                            ...
                            >
                                ...
                                <span className="cat-count" style={{
                                    ...
                                    marginTop: 4,
                                    letterSpacing: '0.01em',
                                }}>{productsData.filter(product => product.category === category).length} items</span>
                                <span
